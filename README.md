...
:warning:  Note that we have used identical values for most of the abovementioned parameters accross all patients to prepare the Open-Full-Jaw dataset. Only a few of them marked below (with  🚧 ) was used to adapt the pipeline's result to the patient-specific geometries.
